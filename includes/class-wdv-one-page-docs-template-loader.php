<?php
/**
 * Template Loader for Plugins (Thanks Gary Jones).
 *
 * @package   SC101_Template_Loader
 * @author    Gary Jones
...
if ( ! class_exists( 'SC101_Template_Loader' ) )  {
	/**
	 * Template loader.
	 *
	...
	class SC101_Template_Loader {
		 ...
		 * @type string
		 */
		protected $filter_prefix = 'sc_101';
		 ...
		 * @type string
		 */
		protected $theme_template_directory = 'public/partials'; // or 'your-plugin-templates' etc.
		 ...
		 * @type string
		 */
		protected $plugin_directory = ABSPATH . 'wp-content/plugins/wdv-one-page-docs/';
		// or plugin_dir_path( dirname( __FILE__ ) ); etc.
		 ...
		 * @type string
		 */
		protected $plugin_template_directory = 'public/partials'; // or includes/templates, etc.
		 ...
		 * @since 1.0.0
		 *
		 * @uses SC101_Template_Loader::get_template_possble_parts() Create file names of templates.
		 * @uses SC101_Template_Loader::locate_template() Retrieve the name of the highest priority template
		 *     file that exists.
		 *
		 * @param string  $slug
